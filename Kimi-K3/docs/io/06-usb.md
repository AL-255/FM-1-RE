...
`Opus4.8/reference/jielie/periph/usb-fs.md`; SDK structure reference in
`Kimi-K3/reference/ac695n_soundbox_sdk/include_lib/driver/device/usb/` (BR23 sibling
...
register reference: `Opus4.8/reference/jielie/periph/usb-fs.md`. Two interrupt
