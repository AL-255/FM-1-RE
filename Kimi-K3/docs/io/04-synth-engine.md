...
Disassembly quotes cite shards in `Kimi-K3/analysis/shards/`. The reference
source is Google **msfa** (`Opus4.8/reference/dexed/Source/msfa/`) and
**Synth_Dexed** (`Opus4.8/reference/Synth_Dexed/src/`) — where the firmware
