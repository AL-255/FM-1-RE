...
Parses analysis/disassembly/app_pi32v2_objdump.txt (file-offset based) plus
...
ENTRIES = os.path.join(ROOT, "analysis", "disassembly", "function_entries_vendor.csv")
APPBIN = os.path.join(ROOT, "firmware-images", "v13", "raw_fw",
